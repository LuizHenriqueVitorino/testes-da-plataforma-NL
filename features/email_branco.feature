...
Funcionalidade: Testar o campo de email na página de cadastro NL
    ...
    Cenário: acessar a página de cadastro NL e falhar no processo por conta de uma tentativa falha de concluir sem inserir
    nenhum dado no campo de email 
        Dado que preenche o campo cpf
        Dado que preenche o campo senha
        Dado que preenche o campo confirme a senha
        Dado que preenche o campo e-mail em branco
